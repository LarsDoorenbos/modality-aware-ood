...
if __name__ == '__main__':
    ...
    if args.far_ood and args.dataset != 'EPIC':
    ...
    for split in splits:
        print(split)
        pred_list, conf_list, label_list, output_list, feature_list, pred_v_list, pred_f_list, feat_v_list, feat_f_list = [], [], [], [], [], [], [], [], []
        ...
        if args.far_ood:
            ...
            vconf_name = './saved_files/id_'+args.ood_dataset+'_near_ood_vconf_' + args.appen + split + '.npy'
            fconf_name = './saved_files/id_'+args.ood_dataset+'_near_ood_fconf_' + args.appen + split + '.npy'
            ...
            v_feature_name = './saved_files/id_'+args.ood_dataset+'_near_ood_vfeature_' + args.appen + split + '.npy'
            f_feature_name = './saved_files/id_'+args.ood_dataset+'_near_ood_ffeature_' + args.appen + split + '.npy'
